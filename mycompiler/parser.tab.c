...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOK_PCTPCT = 4,                 /* TOK_PCTPCT  */
  YYSYMBOL_5_ = 5,                         /* '+'  */
  YYSYMBOL_6_ = 6,                         /* '-'  */
  YYSYMBOL_7_ = 7,                         /* '*'  */
  YYSYMBOL_8_n_ = 8,                       /* '\n'  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "TOK_PCTPCT",
...
{
       5,     7,     6,     0,     1,     1,    15,    16,    17,    18,
       2,     2,     8,     9,    10,    11,     0,     0,    13,     8,
       9,    10,    11,    12,     8,     9,    10,    11,    14,     8,
       0,     0,    11
};

static const yytype_int8 yycheck[] =
{
       2,     3,     0,    -1,     3,     3,     8,     9,    10,    11,
       9,     9,     4,     5,     6,     7,    -1,    -1,    10,     4,
       5,     6,     7,     8,     4,     5,     6,     7,     8,     4,
      -1,    -1,     7
};
...
{
       0,     3,     9,    12,    13,    13,     0,    13,     4,     5,
       6,     7,     8,    10,     8,    13,    13,    13,    13
};
...
#line 1097 "parser.tab.c"
  ...
  case 7: /* expr: expr TOK_PCTPCT expr  */
#line 27 "parser.y"
                           {
          printf("Parsed '%%' operator: %d %% %d\n", yyvsp[-2], yyvsp[0]);
          yyval = yyvsp[-2] * yyvsp[-2] + yyvsp[0] * yyvsp[0] + yyvsp[-2] + yyvsp[0] + 1;
      }
